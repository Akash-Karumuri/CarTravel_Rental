...
const Services = () => {
  ...
  if (loading) return <CarLoader message="Fetching services..." />;
  return (
    <section className="container p-5 mt-5 services">
      <h2>What We Offer</h2>
      <p>
        At AK Car Travels, we pride ourselves on offering a diverse range of
        services designed to cater to your every travel need. Whether you're
        traveling for business, leisure, or a special event, our services are
        tailored to provide convenience, luxury, and reliability. Here's a
        closer look at what we offer:
      </p>
